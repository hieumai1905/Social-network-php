...
<div class="app-footer border-0 shadow-lg bg-primary-gradiant">
    ...
    <a href="default-live-stream.html"
       class="nav-content-bttn"
       data-tab="chats">
        <i class="feather-layout">
        </i>
    </a>
    <a href="shop-2.html" class="nav-content-bttn">
        <i class="feather-layers">
        </i>
    </a>
...
<div class="modal bottom side fade"
     id="Modalstory"
     tabindex="-1"
     role="dialog"
            ...
            <div class="card p-3 d-block border-0 d-block">
                ...
                <a href="#"
                   class="font-xssss position-absolute right-0 top-0 mt-3 me-4">
                    <i class="ti-close text-grey-900 mt-2 d-inline-block">
                    </i>
                </a>
            </div>
        </div>
