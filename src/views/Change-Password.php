                        ...
                        <div class="card-body p-lg-5 p-4 w-100 border-0">
                            <form action="/change-password" method="post" onsubmit="return checkValidation()">
                                ...
                                <div class="col-sm-12 p-0 text-left" style="display: block">
                                    ...
                                    <?php
                                    if(isset($error)){
                                        echo '<p style="color:red; font-size:14px ; display: none;cursor:pointer;" id="notification1">' . $error . '</p>';
                                    }
                                    ?>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12 mb-0">
                                        <p class="bg-current text-center text-white font-xsss fw-600 w175 rounded-3 d-inline-block" style="cursor: pointer;" id="confirm-change-password">
