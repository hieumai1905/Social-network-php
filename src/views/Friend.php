                                    ...
                                    echo "<div class='col-md-3 col-sm-4 pe-2 ps-2'>
                                            <div class='card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3 mt-0'>
                                                <div class='card-body d-block w-100 ps-3 pe-3 pb-4 text-center'>
                                                    <figure class='avatar ms-auto me-auto mb-0 position-relative w65 z-index-1'><img style='width:65px; height:65px; border-radius:50px;' src='$avatar' alt='image' class='float-right p-0 bg-white rounded-circle w-100 shadow-xss'></figure>
