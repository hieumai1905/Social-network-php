...
class MessageController
{
    ...
    function showMessageView()
    {
        ...
        $friendInfo = $this->userService->getById($frendId);
        ...
        return Response::view('views/Message', ['userId' => $userId, 'mesg' => $msg, 'friendId' => $frendId, 'conver'=> $conOfUser->getConversationId(),'friendInfo'=>$friendInfo, 'avatarTest' =>$avatar]);
    }
